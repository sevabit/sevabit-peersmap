...
const getPeers = async () => {
    try {
        const res = await axios.get('http://map.sevabit.com:22049/peers');
...
const getLocation = async (ip) => new Promise((resolve) => {
    cache.get(ip, async (err, value) => {
        ...
        try {
            ...
            const res = await axios.get(`http://api.ipstack.com/${ip}?access_key=a0557bc9193d33940d9a64d9cec356a1&output=json&legacy=1`);
